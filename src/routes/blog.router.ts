...
router.post('/blogs', createBlogValidators, blogController.createBlog.bind(blogController));
...
router.put('/blogs/:id', createBlogValidators, blogController.updateBlog.bind(blogController));
router.delete('/blogs/:id', blogController.deleteBlog.bind(blogController));
router.get('/blogs/:id/comments', commentController.getCommentsByBlog.bind(commentController));
router.post('/comments', commentController.createComment.bind(commentController));
router.get('/users/search', blogController.searchUsers.bind(blogController));
router.get('/blogs/search', blogController.searchBlogs.bind(blogController));
router.put('/comments/:id', commentController.updateComment.bind(commentController));
